...
#ifndef NATAMI_ZNATATRACKER_H
#define NATAMI_ZNATATRACKER_H
...
public:
    CzNATATracker(CWallet* parent);
    ~CzNATATracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNATAWallet* zNATAWallet = NULL);
