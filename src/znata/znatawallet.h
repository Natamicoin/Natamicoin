...
#ifndef NATAMI_ZNATAWALLET_H
#define NATAMI_ZNATAWALLET_H
...
public:
    ...
    void GenerateDeterministicZNATA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNATA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
