...
#define __PORT_MAINNET__ 8228
#define __PORT_TESTNET__ 18228
#define __PORT_REGTEST__ 28228
 ...
 * Natami system. There are three: the main network on which people trade goods
