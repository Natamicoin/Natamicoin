...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NATA features */
        {"natami", "listmasternodes", &listmasternodes, true },
        {"natami", "getmasternodecount", &getmasternodecount, true },
        {"natami", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"natami", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"natami", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"natami", "masternodecurrent", &masternodecurrent, true },
        {"natami", "startmasternode", &startmasternode, true },
        {"natami", "createmasternodekey", &createmasternodekey, true },
        {"natami", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"natami", "listmasternodeconf", &listmasternodeconf, true },
        {"natami", "getmasternodestatus", &getmasternodestatus, true },
        {"natami", "getmasternodewinners", &getmasternodewinners, true },
        {"natami", "getmasternodescores", &getmasternodescores, true },
        {"natami", "preparebudget", &preparebudget, true },
        {"natami", "submitbudget", &submitbudget, true },
        {"natami", "mnbudgetvote", &mnbudgetvote, true },
        {"natami", "getbudgetvotes", &getbudgetvotes, true },
        {"natami", "getnextsuperblock", &getnextsuperblock, true },
        {"natami", "getbudgetprojection", &getbudgetprojection, true },
        {"natami", "getbudgetinfo", &getbudgetinfo, true },
        {"natami", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"natami", "mnfinalbudget", &mnfinalbudget, true },
        {"natami", "checkbudgets", &checkbudgets, true },
        {"natami", "mnsync", &mnsync, true },
        {"natami", "spork", &spork, true },
        ...
        {"zerocoin", "getznataseed", &getznataseed, false },
        {"zerocoin", "setznataseed", &setznataseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdznata", &searchdznata, false },
        {"zerocoin", "dznatastate", &dznatastate, false },
...
{
    return "> natami-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8227/\n";
}
