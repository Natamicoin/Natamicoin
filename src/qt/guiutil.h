...
/** Utility functions used by the Natami Qt UI.
 */
namespace GUIUtil
{
...
// Render NATA addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZnata = false);
...
// Parse "natami:" URI into recipient object, return true on successful parsing
