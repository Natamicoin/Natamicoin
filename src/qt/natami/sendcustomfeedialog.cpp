...
#include "qt/natami/sendcustomfeedialog.h"
#include "qt/natami/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(NATAMIGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &NATAMIGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
