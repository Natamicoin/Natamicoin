...
#include "qt/natami/furabstractlistitemdelegate.h"
#include "qt/natami/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/natami/txviewholder.h"
...
#include "config/natami-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(NATAMIGUI* _window);
    ~DashboardWidget();
