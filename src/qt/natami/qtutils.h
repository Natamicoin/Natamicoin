...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, NATAMIGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, NATAMIGUI* gui, double posX = 3);
