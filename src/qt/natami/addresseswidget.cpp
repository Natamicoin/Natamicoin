...
#include "qt/natami/forms/ui_addresseswidget.h"
#include "qt/natami/addresslabelrow.h"
#include "qt/natami/addnewaddressdialog.h"
#include "qt/natami/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(NATAMIGUI* parent) :
    PWidget(parent),
