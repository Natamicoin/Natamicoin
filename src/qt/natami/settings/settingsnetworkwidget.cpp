...
#include "qt/natami/settings/settingsnetworkwidget.h"
#include "qt/natami/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/natami/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NATAMIGUI* _window, QWidget *parent) :
