...
#include "qt/natami/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(NATAMIGUI* parent) :
    PWidget(parent),
...
//    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &NATAMIGUI::openFAQ);
