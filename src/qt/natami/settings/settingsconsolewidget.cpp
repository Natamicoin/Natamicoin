...
#include "qt/natami/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/natami/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(NATAMIGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("<u>Welcome to the NATA RPC console.</u>") + "<br>" +
