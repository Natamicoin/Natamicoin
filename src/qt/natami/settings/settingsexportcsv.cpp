...
#include "qt/natami/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(NATAMIGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Natami_tx_csv_export(*.csv)") : tr("Natami_addresses_csv_export(*.csv)"),
                                        nullptr);
