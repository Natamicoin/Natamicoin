...
#include "qt/natami/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/natami/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NATAMIGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NATAMIGUI::handleRestart()
