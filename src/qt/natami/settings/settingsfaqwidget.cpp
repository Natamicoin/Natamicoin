...
#include "qt/natami/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/natami/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(NATAMIGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &NATAMIGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
