...
#include "qt/natami/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/natami/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NATAMIGUI* _window, QWidget *parent) :
