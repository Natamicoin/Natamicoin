...
QString BitcoinUnits::id(int unit)
{
    ...
    case PIV:
        return QString("NATA");
    case mPIV:
        return QString("mNATA");
    case uPIV:
        return QString::fromUtf8("uNATA");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZnata)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZNATA)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZNATA);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZNATA)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZNATA));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
