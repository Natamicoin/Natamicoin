...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            NATAMIGUI* window = static_cast<NATAMIGUI*>(parentWidget());
...
{
    NATAMIGUI* gui = static_cast<NATAMIGUI*>(parentWidget());
...
{
    hide();
    static_cast<NATAMIGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Natami will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your NATAs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
