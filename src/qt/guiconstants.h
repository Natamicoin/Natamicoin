...
/* Natami GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Natami"
#define QAPP_ORG_DOMAIN "natami.org"
#define QAPP_APP_NAME_DEFAULT "Natami-Qt"
#define QAPP_APP_NAME_TESTNET "Natami-Qt-testnet"
