...
#ifndef NATAMI_STAKEINPUT_H
#define NATAMI_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZNATA() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CNataStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZNATA() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //NATAMI_STAKEINPUT_H
