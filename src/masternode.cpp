...
{
    if (nHeight >  1600000) return    380000 * COIN;
    if (nHeight >  1500000) return    340000 * COIN;
    if (nHeight >  1400000) return    300000 * COIN;
    if (nHeight >  1300000) return    260000 * COIN;
    if (nHeight >  1200000) return    220000 * COIN;
    if (nHeight >  1100000) return    180000 * COIN;
    if (nHeight >  1000000) return    160000 * COIN;
    if (nHeight >  9000000) return    140000 * COIN;
    if (nHeight >  800000) return     120000 * COIN;
    if (nHeight >  700000) return     110000 * COIN;
    if (nHeight >  600000) return     100000 * COIN;
    if (nHeight >  500000) return     90000 * COIN;
    if (nHeight >  400000) return     80000 * COIN;
    if (nHeight >  300000) return     70000 * COIN;
    if (nHeight >  200000) return     60000 * COIN;
    if (nHeight >  100000) return     50000 * COIN;
    if (nHeight >  50000)  return     40000 * COIN;
    if (nHeight >  15000) return      35000 * COIN;
    if (nHeight >   2000) return      30000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    else if (nHeight <= 1698855) { 
        nSubsidy = 1216 * COIN;
    }
    else if (nHeight == 1698856) { 
        nSubsidy = 450 * COIN;
    }
    else if (nHeight >= 1698857) { 
        nSubsidy = 0 * COIN;
    }
...
{
     if (nHeight > 2000) return GetBlockValue(nHeight) * 80 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 NATA tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 NATA tx -> 1 confirmation
