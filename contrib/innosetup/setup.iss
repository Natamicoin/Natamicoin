...
#define MyAppName "Natami"
#define MyAppPublisher "2022 Natami developers"
#define MyAppURL "https://natamicoin.org/"
#define MyAppExeName "natami-qt.exe"
//#define MyAppExtraData "https://scan.natamicoin.org/bootstraps/NATA/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=NatamiSetup
...
[Files]
Source: ".\package\natami-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Natami\Natami-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Natami\Natami-Qt,strDataDir|{userappdata}\Natami\}');
  Result := True;
end;
