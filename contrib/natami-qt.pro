...
RESOURCES += src/qt/natami.qrc src/qt/natami_locale.qrc

TRANSLATIONS += src/qt/locale/natami_bg.ts \
                src/qt/locale/natami_de.ts \
                src/qt/locale/natami_en.ts \
                src/qt/locale/natami_es.ts \
                src/qt/locale/natami_fi.ts \
                src/qt/locale/natami_fr.ts \
                src/qt/locale/natami_it.ts \
                src/qt/locale/natami_ja.ts \
                src/qt/locale/natami_pl.ts \
                src/qt/locale/natami_pt.ts \
                src/qt/locale/natami_ru.ts \
                src/qt/locale/natami_sk.ts \
                src/qt/locale/natami_sv.ts \
                src/qt/locale/natami_vi.ts \
                src/qt/locale/natami_zh_CN.ts \
                src/qt/locale/natami_zh_TW.ts
