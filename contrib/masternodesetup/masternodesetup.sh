...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='natami.conf'
CONFIGFOLDER='/root/.natami'
COIN_DAEMON='natamid'
COIN_CLI='natami-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Natamicoin/Natamicoin/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
