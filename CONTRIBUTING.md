Contributing to Natami Core
============================

The Natami Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Natami-NaturaAmica/Natamicoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Natami Core project, and is not to be
confused with overall Natami Network Protocol consensus changes.

Whether a pull request is merged into Natami Core rests with the project merge
...
Patches that change Natami consensus rules are considerably more involved than
...
Where a patchset proposes to change the Natami consensus, it must have been
...
The project leader is the release manager for each Natami Core release.
